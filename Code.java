...
public class Code 
{
	...
	{
		int arg = getArg(i);
		//String s = Integer.toHexString(arg);
		//arg = Integer.parseInt(s);
		int a = getOp(i);
		int b = getIndirLvl(i);
		
		String str = Integer.toHexString(a).toUpperCase()+" "+ Integer.toHexString(b).toUpperCase() + " ";
		int c = arg;
		if(arg<0)
		{
			c = -arg;
		...
		str+= Integer.toHexString(c).toUpperCase();
	...
	public String getText(int i)
	{
		...
		int arg = getArg(i);
		System.out.println(arg + " " + Integer.toHexString(arg));
		if(arg>=0)
		{
